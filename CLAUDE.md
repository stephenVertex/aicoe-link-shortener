...
**YOU ARE IN: `aicoe_link_shortener/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/aicoe_link_shortener/` (rig root) or other directories
...
**Your mail address:** `aicoe_link_shortener/polecats/furiosa`
**Your rig:** aicoe_link_shortener
**Your Witness:** `aicoe_link_shortener/witness`
...
| Ask Witness for help | `gt mail send aicoe_link_shortener/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`aicoe_link_shortener/witness`) when:
...
```bash
gt mail send aicoe_link_shortener/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
