...
def help_cmd():
    ...
    sections = [
        ...
        (
            ...
            [
                "# Create a short link (note the generated slug)",
                "als shorten https://linkedin.com/in/yourname",
                "als shorten https://trilogyai.substack.com",
                "# Then pin it by its slug:",
                "als links pin <slug-from-above>",
                "",
        ...
        (
            "7. Create a personal short link",
            "You want a short URL for your LinkedIn profile, GitHub, etc.",
            [
                'als shorten "https://linkedin.com/in/yourname"',
                "# → aicoe.fit/<auto-generated-slug>",
            ],
        ),
        (
